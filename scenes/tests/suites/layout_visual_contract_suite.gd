...
func _test_recipe_scene_loads() -> void:
	...
	await _settle_frames(2)
	_check(recipe_scene.get_node_or_null("RootMargin/RootVBox/RecipesGrid/DeckColumn/DeckPanel/DeckZone") is Zone, "recipe scene should include a ready-to-use deck zone")
	_check(recipe_scene.get_node_or_null("RootMargin/RootVBox/RecipesGrid/HandColumn/HandPanel/HandZone") is Zone, "recipe scene should include a ready-to-use hand zone")
	_check(recipe_scene.get_node_or_null("RootMargin/RootVBox/RecipesGrid/BoardColumn/BoardPanel/BoardZone") is Zone, "recipe scene should include a ready-to-use board zone")
	_check(recipe_scene.get_node_or_null("RootMargin/RootVBox/RecipesGrid/DiscardColumn/DiscardPanel/DiscardZone") is Zone, "recipe scene should include a ready-to-use discard zone")
