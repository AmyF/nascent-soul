...
const XiangqiBoardOverlayScript = preload("res://scenes/showcases/xiangqi/xiangqi_board_overlay.gd")
const XiangqiBoardRegistryScript = preload("res://scenes/showcases/xiangqi/xiangqi_board_registry.gd")
const XiangqiHistoryScript = preload("res://scenes/showcases/xiangqi/xiangqi_history.gd")
const XiangqiMoveRulesScript = preload("res://scenes/showcases/xiangqi/xiangqi_move_rules.gd")
...
const XiangqiTargetPolicyScript = preload("res://scenes/showcases/xiangqi/xiangqi_target_policy.gd")
