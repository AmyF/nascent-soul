...
- Added built-in targeting resources and visuals, including `ZoneTargetingIntent`, `ZoneTargetingPolicy`, `ZoneArrowTargetingStyle`, and `ZoneArrowTargetingOverlay`.
...
- Headless regression suite passes on Godot 4.6.1 with `382` checks.
